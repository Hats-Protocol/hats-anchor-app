          ...
          <AccordionPanel>
            <div className='flex flex-col gap-2'>
              <div className='flex gap-4'>
                <Link href={`https://ipfs.io/ipfs/${hash.slice(7)}`} target='_blank' rel='noopener noreferrer'>
...
const HatDetailsChanges = () => {
  ...
  return (
    <div className='mx-auto flex w-[90%] flex-col justify-center gap-4 py-32 md:w-[60%]'>
      <h1 className='text-lg font-bold md:text-2xl'>{selectedHatDetails?.name} Details Changes</h1>
