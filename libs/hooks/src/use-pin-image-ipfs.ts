 ...
 * @param imageFile - the image file to pin
 * @param enabled -  whether the hook should be activated or not
 * @param metadata - key-value object with the image metadata, as should be sent to Pinata
