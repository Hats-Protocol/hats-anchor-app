...
const useHatMakeImmutable = ({
  ...
  const { writeAsync, isLoading } = useHatContractWrite({
    ...
    successToastData: {
      title: 'Hat Updated!',
      description: selectedHatId && `Successfully made hat #${hatIdDecimalToIp(BigInt(selectedHatId))} immutable`,
    },
...
export { useHatMakeImmutable, type UseHatMakeImmutableProps };
