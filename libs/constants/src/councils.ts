...
export const HATS_ADDRESS = '0x3bc1A0Ad72417f2d411118085256fC53CBdDd137' as const;
...
export const HATS_MODULES_FACTORY_ADDRESS = '0x0a3f85fa597B6a967271286aA0724811acDF5CD9' as const;
...
export const MULTI_CLAIMS_HATTER_V1_ADDRESS = '0xB985eA1be961f7c4A4C45504444C02c88c4fdEF9' as const;
...
export const AGREEMENT_ELIGIBILITY_ABI = [
  ...
  {
    inputs: [{ internalType: 'address[]', name: '_wearers', type: 'address[]' }],
    name: 'forgive',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_newArbitratorHat', type: 'uint256' }],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_newOwnerHat', type: 'uint256' }],
    name: 'setOwnerHat',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'address', name: '_claimsHatter', type: 'address' }],
...
export const HSG_V2_ABI = [
  ...
  {
    inputs: [{ internalType: 'uint256[]', name: '_newSignerHats', type: 'uint256[]' }],
    name: 'addSignerHats',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'signerCount', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
