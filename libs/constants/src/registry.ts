export const modules = [
    {
      id: 'haberdasher-labs_agreement-eligibility',
      version: 'v0.1.0',
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/Hats-Protocol/agreement-eligibility' }],
      parameters: [
        { label: 'Current Agreement', functionName: 'currentAgreement', displayType: 'default' },
        { label: 'Grace Period Ending', functionName: 'graceEndsAt', displayType: 'timestamp' },
        { label: 'Owner Hat', functionName: 'OWNER_HAT', displayType: 'hat' },
        { label: 'Arbitrator Hat', functionName: 'ARBITRATOR_HAT', displayType: 'hat' },
      ],
      type: { eligibility: true, toggle: false, hatter: false },
      tags: [{ description: 'Indicates that the module is now deprecated', label: 'Deprecated', value: 'deprecated' }],
      ...
      creationArgs: {
        ...
        immutable: [
          ...
          },
          {
            name: 'Arbitrator Hat',
            description:
              'The hat ID for the arbitrator hat. The wearer(s) of this hat are authorized to set the standing for accounts.',
            type: 'uint256',
            example: '26959946667150639794667015087019630673637144422540572481103610249216',
            displayType: 'hat',
          },
      ...
      customRoles: [
        { id: 'agreementOwner', name: 'Agreement Owner', criteria: 'OWNER_HAT' },
        { id: 'agreementArbitrator', name: 'Agreement Arbitrator', criteria: 'ARBITRATOR_HAT' },
      ],
      writeFunctions: [
        {
          roles: ['public'],
        ...
        },
        {
          ...
          args: [
            ...
            },
            {
              name: 'Grace Period',
              description:
                'The new grace period - the time duration for which signers of the existing agreement are still eligible',
              type: 'uint256',
              displayType: 'seconds',
            },
          ],
      ...
      abi: [
        ...
        { inputs: [], name: 'AgreementEligibility_NotOwner', type: 'error' },
        {
          anonymous: false,
          inputs: [
            { indexed: false, internalType: 'string', name: 'agreement', type: 'string' },
            { indexed: false, internalType: 'uint256', name: 'grace', type: 'uint256' },
          ],
    ...
    },
    {
      ...
      parameters: [
        { label: 'Current Agreement', functionName: 'currentAgreement', displayType: 'default' },
        { label: 'Grace Period Ending', functionName: 'graceEndsAt', displayType: 'timestamp' },
        { label: 'Owner Hat', functionName: 'ownerHat', displayType: 'hat' },
        { label: 'Arbitrator Hat', functionName: 'arbitratorHat', displayType: 'hat' },
      ],
      type: { eligibility: true, toggle: false, hatter: false },
      implementationAddress: '0x8126d02F4EcDE43eca4543a0D90B755C3E225F09',
      tags: [{ description: 'Indicates that the module is now deprecated', label: 'Deprecated', value: 'deprecated' }],
      deployments: [
        { chainId: '11155111', block: '5906105' },
        { chainId: '10', block: '120018528' },
        { chainId: '42161', block: '210962674' },
        { chainId: '100', block: '33952979' },
        { chainId: '42220', block: '25593018' },
        { chainId: '8453', block: '14482815' },
        { chainId: '137', block: '56934657' },
      ],
      creationArgs: {
        useHatId: true,
        immutable: [],
      ...
      customRoles: [
        { id: 'agreementOwner', name: 'Agreement Owner', criteria: 'ownerHat' },
        { id: 'agreementArbitrator', name: 'Agreement Arbitrator', criteria: 'arbitratorHat' },
      ],
      writeFunctions: [
        {
          roles: ['public'],
      ...
      abi: [
        ...
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: 'uint256', name: 'newArbitratorHat', type: 'uint256' }],
        ...
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: 'uint256', name: 'newOwnerHat', type: 'uint256' }],
    ...
    },
    {
      ...
      details: [
        'A Hats Protocol eligibility module that a community or organization can use to enable individuals to join the community by signing an agreement.',
        'This version is compatible with module chaining.',
      ],
      links: [{ label: 'GitHub', link: 'https://github.com/Hats-Protocol/agreement-eligibility' }],
      parameters: [
        { label: 'Current Agreement', functionName: 'currentAgreement', displayType: 'default' },
      ...
      tags: [{ description: 'Indicates that the module is now deprecated', label: 'Deprecated', value: 'deprecated' }],
      deployments: [
        { chainId: '11155111', block: '6668466' },
        { chainId: '10', block: '125200844' },
        { chainId: '42161', block: '252171575' },
        { chainId: '100', block: '35935044' },
        { chainId: '42220', block: '27665681' },
        { chainId: '8453', block: '19605730' },
        { chainId: '137', block: '61667610' },
        { chainId: '1', block: '20722687' },
      ],
      creationArgs: {
        useHatId: true,
        immutable: [],
    ...
    },
    {
      ...
      type: { eligibility: true, toggle: false, hatter: false },
      implementationAddress: '0x4F10B9e99ce11f081652646f4b192ed1b812D5Bb',
      tags: [],
      deployments: [
        { chainId: '11155111', block: '6871117' },
        { chainId: '10', block: '126708838' },
        { chainId: '42161', block: '264150811' },
        { chainId: '100', block: '36521638' },
        { chainId: '42220', block: '28268854' },
        { chainId: '8453', block: '21113616' },
        { chainId: '84532', block: '23152690' },
        { chainId: '137', block: '63077931' },
        { chainId: '1', block: '21017026' },
      ],
      creationArgs: {
        useHatId: true,
        immutable: [],
      ...
      writeFunctions: [
        ...
        },
        {
          ...
          args: [
            {
              name: 'Wearers',
              description: 'The addresses of the wearers from whom to revoke the hats',
              type: 'address[]',
              displayType: 'default',
            },
          ],
        ...
        },
        {
          ...
          args: [
            {
              name: 'Wearers',
              description: 'The addresses of the wearers to forgive',
              type: 'address[]',
              displayType: 'default',
            },
          ],
      ...
      abi: [
        ...
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: 'address', name: 'wearer', type: 'address' }],
          name: 'AgreementEligibility_Forgiven',
          type: 'event',
        },
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: 'address[]', name: 'wearers', type: 'address[]' }],
          name: 'AgreementEligibility_Forgiven',
          type: 'event',
        },
        {
    ...
    {
      id: 'haberdasher-labs_allowlist-eligibility',
      version: 'v0.1.0',
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/Hats-Protocol/allowlist-eligibility' }],
      parameters: [
        { label: 'Owner Hat', functionName: 'OWNER_HAT', displayType: 'hat' },
        { label: 'Arbitrator Hat', functionName: 'ARBITRATOR_HAT', displayType: 'hat' },
      ],
        ...
        immutable: [
          {
            name: 'Owner Hat',
            description:
              'The hat ID for the owner hat. The wearer(s) of this hat are authorized to add and remove accounts from the allowlist.',
            type: 'uint256',
            example: '26959946667150639794667015087019630673637144422540572481103610249216',
            displayType: 'hat',
          },
        ...
        mutable: [
          {
            ...
            type: 'address[]',
            example: ['0x0000000000000000000000000000000000000001', '0x0000000000000000000000000000000000000002'],
            displayType: 'default',
          },
        ],
      },
      customRoles: [
        { id: 'allowListOwner', name: 'Allowlist Owner', criteria: 'OWNER_HAT' },
        { id: 'allowListArbitrator', name: 'Allowlist Arbitrator', criteria: 'ARBITRATOR_HAT' },
      ],
      writeFunctions: [
        {
          ...
          primary: true,
          args: [{ name: 'Account', description: 'The account to add', type: 'address', displayType: 'default' }],
        },
        {
          roles: ['allowListOwner'],
          ...
          args: [{ name: 'Accounts', description: 'The accounts to add', type: 'address[]', displayType: 'default' }],
        },
        {
          roles: ['allowListOwner'],
          ...
          args: [{ name: 'Account', description: 'The account to remove', type: 'address', displayType: 'default' }],
        },
        {
          roles: ['allowListOwner'],
        ...
        },
        {
          ...
          args: [{ name: 'Accounts', description: 'Accounts to remove', type: 'address[]', displayType: 'default' }],
        },
        {
          ...
          args: [
            ...
            { name: 'Standing', description: 'The standing to set', type: 'bool', displayType: 'default' },
          ],
        },
        {
          roles: ['allowListArbitrator'],
      ...
      abi: [
        ...
        { inputs: [], name: 'AllowlistEligibility_ArrayLengthMismatch', type: 'error' },
    ...
    },
    {
      ...
      tags: [{ description: 'Indicates that the module is now deprecated', label: 'Deprecated', value: 'deprecated' }],
      deployments: [
        { chainId: '11155111', block: '5906201' },
        { chainId: '10', block: '120018916' },
        { chainId: '137', block: '56934846' },
        { chainId: '42161', block: '210966200' },
        { chainId: '100', block: '33953289' },
        { chainId: '8453', block: '14483153' },
        { chainId: '42220', block: '25623525' },
      ],
      creationArgs: {
        useHatId: true,
        immutable: [],
      ...
      customRoles: [
        { id: 'allowListOwner', name: 'Allowlist Owner', criteria: 'ownerHat' },
        { id: 'allowListArbitrator', name: 'Allowlist Arbitrator', criteria: 'arbitratorHat' },
      ],
      writeFunctions: [
        {
          roles: ['allowListOwner'],
    ...
    },
    {
      ...
      type: { eligibility: true, toggle: false, hatter: false },
      implementationAddress: '0x80336fb7b6B653686eBe71d2c3ee685b70108B8f',
      tags: [],
      deployments: [
        { chainId: '11155111', block: '6669160' },
        { chainId: '1', block: '21947580' },
        { chainId: '10', block: '125208683' },
        { chainId: '137', block: '61674801' },
        { chainId: '42161', block: '252235066' },
        { chainId: '100', block: '35938116' },
        { chainId: '8453', block: '19613487' },
        { chainId: '84532', block: '23157396' },
        { chainId: '42220', block: '27668833' },
      ],
      creationArgs: {
        useHatId: true,
        immutable: [],
    ...
    },
    {
      ...
      parameters: [
        { label: 'Baal Contract', functionName: 'BAAL', displayType: 'address' },
        { label: 'Staking Token', functionName: 'SHARES_TOKEN', displayType: 'erc20' },
        { label: 'Minimum Stake', functionName: 'minStake', displayType: 'default' },
        { label: 'Cooldown Period', functionName: 'cooldownPeriod', displayType: 'seconds' },
        { label: 'Judge Hat (Can Set Wearer Standing)', functionName: 'judge', displayType: 'hat' },
      ],
      type: { eligibility: true, toggle: false, hatter: false },
      tags: [],
      ...
      creationArgs: {
        ...
        immutable: [
          ...
          },
          {
            ...
            description:
              'The address of the staking proxy implementation. This enables staked votes to be delegated back to the staker or a delegate of their choice.',
            type: 'address',
        ...
        mutable: [
          {
            ...
            description:
              "The number of seconds that must elapse between beginning an unstake and completing it, in addition to the Baal's voting period and grace period",
            type: 'uint32',
            example: 86400,
            displayType: 'seconds',
          },
      ...
      customRoles: [{ id: 'baalStakingJudge', name: 'Staking Judge', criteria: 'judge' }],
      writeFunctions: [
        {
          roles: ['public'],
        ...
        },
        {
          ...
          label: 'Begin Unstake',
          description:
            'Begin the process of unstaking an amount tokens by initiating a cooldown period, after which the tokens can be unstaked if the staker is not slashed in the meantime.',
          args: [
            {
              name: 'Amount',
        ...
        },
        {
          ...
          args: [{ name: 'Hat', description: 'The new judge hat', type: 'uint256', displayType: 'hat' }],
        },
        {
          ...
          args: [
            ...
            { name: 'Standing', description: 'The new standing of the wearer', type: 'bool', displayType: 'default' },
          ],
        },
      ],
      abi: [
        ...
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: 'uint256', name: 'judge', type: 'uint256' }],
          name: 'JudgeSet',
          type: 'event',
        },
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: 'uint112', name: 'minStake', type: 'uint112' }],
          name: 'MinStakeSet',
          type: 'event',
        },
        {
        ...
        },
        {
          inputs: [],
          name: 'BAAL',
          outputs: [{ internalType: 'contract IBaal', name: '', type: 'address' }],
          stateMutability: 'pure',
          type: 'function',
        },
        {
        ...
        },
        {
          inputs: [],
          name: 'SHARES_TOKEN',
          outputs: [{ internalType: 'contract IBaalToken', name: '', type: 'address' }],
          stateMutability: 'view',
          type: 'function',
        },
        {
        ...
        {
          inputs: [{ internalType: 'uint112', name: '_amount', type: 'uint112' }],
          name: 'beginUnstake',
          outputs: [],
          stateMutability: 'nonpayable',
          type: 'function',
        ...
        {
          inputs: [{ internalType: 'contract MultiClaimsHatter', name: '_claimsHatter', type: 'address' }],
          name: 'claim',
          outputs: [],
          stateMutability: 'nonpayable',
          type: 'function',
        ...
        {
          inputs: [{ internalType: 'address', name: '_newDelegate', type: 'address' }],
          name: 'delegate',
          outputs: [],
          stateMutability: 'nonpayable',
          type: 'function',
        ...
        },
        {
          inputs: [{ internalType: 'address', name: '_member', type: 'address' }],
          name: 'memberStakes',
          outputs: [{ internalType: 'uint112', name: 'totalStaked', type: 'uint112' }],
          stateMutability: 'view',
          type: 'function',
        },
        {
        ...
        {
          inputs: [{ internalType: 'uint112', name: '_newUnstakingAmount', type: 'uint112' }],
          name: 'resetUnstake',
          outputs: [],
          stateMutability: 'nonpayable',
          type: 'function',
        ...
        {
          inputs: [{ internalType: 'uint256', name: '_judge', type: 'uint256' }],
          name: 'setJudge',
          outputs: [],
          stateMutability: 'nonpayable',
          type: 'function',
        ...
        {
          inputs: [{ internalType: 'uint112', name: '_minStake', type: 'uint112' }],
          name: 'setMinStake',
          outputs: [],
          stateMutability: 'nonpayable',
          type: 'function',
        ...
        },
        {
          inputs: [
            { internalType: 'uint112', name: '_amount', type: 'uint112' },
            { internalType: 'address', name: '_delegate', type: 'address' },
            { internalType: 'contract MultiClaimsHatter', name: '_claimsHatter', type: 'address' },
          ],
          name: 'stakeAndClaim',
          outputs: [],
          stateMutability: 'nonpayable',
        ...
        },
        {
          ...
          outputs: [
            ...
            { internalType: 'uint112', name: 'unstakingAmount', type: 'uint112' },
            { internalType: 'uint32', name: 'canUnstakeAfter', type: 'uint32' },
          ],
          stateMutability: 'view',
          type: 'function',
        },
    ...
    {
      id: 'haberdasher-labs_colinks-supply-eligibility',
      version: 'v0.1.0',
      ...
      links: [
        { label: 'GitHub', link: 'https://github.com/Hats-Protocol/colinks-eligibility' },
        { label: 'CoLinks', link: 'https://colinks.coordinape.com/' },
      ],
      parameters: [
        { label: 'Link Supply Threshold', functionName: 'THRESHOLD', displayType: 'uint256' },
        { label: 'CoLinks Contract', functionName: 'COLINKS', displayType: 'address' },
      ],
      type: { eligibility: true, toggle: false, hatter: false },
      tags: [],
      ...
      abi: [
        ...
        },
        {
          inputs: [],
          name: 'COLINKS',
          outputs: [{ internalType: 'contract CoLinksLike', name: '', type: 'address' }],
          stateMutability: 'view',
          type: 'function',
        },
        {
    ...
    {
      id: 'haberdasher-labs_eligibility-chain',
      version: 'v0.1.0',
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/Hats-Protocol/hats-module' }],
      parameters: [
        { label: 'Number Of Conjunction Clauses', functionName: 'NUM_CONJUNCTION_CLAUSES', displayType: 'default' },
        { label: 'Length Of Each Clause', functionName: 'CONJUNCTION_CLAUSE_LENGTHS', displayType: 'default' },
        { label: 'Module Addresses', functionName: 'MODULES', displayType: 'default' },
      ],
      type: { eligibility: true, toggle: false, hatter: false },
      tags: [
        { description: 'Indicates that the module is now deprecated', label: 'Deprecated', value: 'deprecated' },
        {
    ...
    },
    {
      ...
      deployments: [
        { chainId: '1', block: '19574101' },
        { chainId: '11155111', block: '5619276' },
        { chainId: '10', block: '118266826' },
        { chainId: '42161', block: '197106608' },
        { chainId: '8453', block: '12672147' },
        { chainId: '84532', block: '23151693' },
        { chainId: '100', block: '33253671' },
        { chainId: '42220', block: '24892601' },
        { chainId: '137', block: '55391825' },
      ],
      creationArgs: {
        useHatId: true,
        immutable: [
    ...
    {
      id: 'haberdasher-labs_gitcoin-passport-eligibility',
      version: 'v0.1.0',
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/daocoa/gitcoin-passport-eligibility/' }],
      parameters: [
        { label: 'Gitcoin Passport Decoder', functionName: 'gitcoinPassportDecoder', displayType: 'default' },
        { label: 'Score Criterion', functionName: 'scoreCriterion', displayType: 'default' },
      ],
      type: { eligibility: true, toggle: false, hatter: false },
      tags: [],
        ...
        immutable: [
          {
            ...
            description:
              'The address of the Gitcoin Passport Decoder contract, from which Passport scores are retrieved. You can find the latest deployment here: https://github.com/gitcoinco/passport/blob/main/deployments/onchainInfo.json',
            type: 'address',
      ...
      abi: [
        ...
        },
        {
          ...
          outputs: [{ internalType: 'contract IGitcoinPassportDecoder', name: '', type: 'address' }],
          stateMutability: 'pure',
          type: 'function',
        },
        {
        ...
        {
          inputs: [{ internalType: 'address', name: 'wearer', type: 'address' }],
          name: 'isHuman',
          outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
          stateMutability: 'view',
          type: 'function',
    ...
    {
      id: 'haberdasher-labs_hat-controlled-module',
      version: 'v0.1.0',
      name: 'Hat Controlled Module',
      details: [
        'Enables an authorized controller hat to set wearer status and/or hat activation status for other hat(s).',
        'Unlike Passthrough Module, this module will work even when chained together with other modules.',
      ],
      links: [{ label: 'GitHub', link: 'https://github.com/Hats-Protocol/passthrough-modules' }],
      parameters: [{ label: 'Controller Hat', functionName: 'CONTROLLER_HAT', displayType: 'hat' }],
      type: { eligibility: true, toggle: true, hatter: false },
      tags: [],
      implementationAddress: '0x94702C4337BB5BF59A2B6c4E0187333b180d153B',
      deployments: [
        { chainId: '11155111', block: '6686024' },
        { chainId: '10', block: '125364801' },
        { chainId: '137', block: '61819779' },
        { chainId: '42161', block: '253476246' },
        { chainId: '100', block: '35999017' },
        { chainId: '8453', block: '19769801' },
        { chainId: '84532', block: '23157860' },
        { chainId: '42220', block: '27731366' },
      ],
      creationArgs: {
        useHatId: true,
        immutable: [
          {
            name: 'Controller Hat',
            description:
              'The hat that will control wearer eligibility and/or activation status of hats controlled by this module',
            type: 'uint256',
      ...
      customRoles: [{ id: 'controller', name: 'Eligibility/Toggle Controller', criteria: 'CONTROLLER_HAT' }],
      writeFunctions: [
        {
          roles: ['controller'],
          functionName: 'setWearerStatus',
          ...
          args: [
            {
              name: 'Wearer',
              description: 'The address to set the wearer status for',
              type: 'address',
              displayType: 'default',
            },
            {
              name: 'Hat',
              description: 'ID of the hat to set the wearer status for',
              type: 'uint256',
              displayType: 'hat',
            },
            {
        ...
        },
        {
          ...
          args: [
            { name: 'Hat', description: 'ID of the hat to set the status for', type: 'uint256', displayType: 'hat' },
            { name: 'Status', description: 'Is the hat active', type: 'bool', displayType: 'default' },
          ],
        },
      ],
      abi: [
        ...
        },
        {
          anonymous: false,
          inputs: [
            { indexed: false, internalType: 'address', name: 'wearer', type: 'address' },
            { indexed: false, internalType: 'uint256', name: 'hatId', type: 'uint256' },
    ...
    {
      id: 'haberdasher-labs_hat-wearing-eligibility',
      version: 'v0.1.0',
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/Hats-Protocol/hat-wearing-eligibility' }],
      parameters: [{ label: 'Hat To Wear', functionName: 'CRITERION_HAT', displayType: 'hat' }],
      type: { eligibility: true, toggle: false, hatter: false },
      tags: [],
    ...
    {
      id: 'haberdasher-labs_hats-election-eligibility',
      version: 'v0.1.0',
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/Hats-Protocol/hats-elections-eligibility' }],
      parameters: [
        { label: 'Admin Hat ID', functionName: 'ADMIN_HAT', displayType: 'hat' },
        { label: 'Ballot Box Hat ID', functionName: 'BALLOT_BOX_HAT', displayType: 'hat' },
        { label: 'Current Term End', functionName: 'currentTermEnd', displayType: 'timestamp' },
        { label: 'Next Term End', functionName: 'nextTermEnd', displayType: 'timestamp' },
      ],
      type: { eligibility: true, toggle: false, hatter: false },
      tags: [{ description: 'Indicates that the module is now deprecated', label: 'Deprecated', value: 'deprecated' }],
      ...
      creationArgs: {
        ...
        immutable: [
          ...
          },
          {
            name: 'Admin Hat',
            description:
              'Optional admin hat, granted authority to set up a new term. If not provided (equals zero), then this permission is granted to the admins of the hat.',
            type: 'uint256',
            example: '26959946667150639794667015087019630673637144422540572481103610249216',
            displayType: 'hat',
            optional: true,
      ...
      customRoles: [
        { id: 'electionsBallotBox', name: 'Elections Ballot Box', criteria: 'BALLOT_BOX_HAT' },
        { id: 'electionsAdmin', name: 'Elections Admin', criteria: 'ADMIN_HAT', hatAdminsFallback: true },
      ],
      writeFunctions: [
        {
          roles: ['public'],
        ...
        },
        {
          ...
          label: 'set Next Term',
          description:
            'Set the next term. This will open the election for the next term. If the next term has already been set and is still open, this function can be used to change it.',
          primary: true,
          args: [
            {
              name: 'New Term End',
      ...
      abi: [
        ...
        { inputs: [], name: 'TooManyWinners', type: 'error' },
        {
          anonymous: false,
          inputs: [
            { indexed: false, internalType: 'uint128', name: 'termEnd', type: 'uint128' },
        ...
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: 'uint128', name: 'nextTermEnd', type: 'uint128' }],
          name: 'ElectionOpened',
          type: 'event',
        },
        {
        ...
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: 'uint128', name: 'termEnd', type: 'uint128' }],
          name: 'NewTermStarted',
          type: 'event',
        },
        {
        ...
        },
        {
          inputs: [
            { internalType: 'uint128', name: '_termEnd', type: 'uint128' },
            { internalType: 'address[]', name: '_recallees', type: 'address[]' },
          ],
          name: 'recall',
          outputs: [],
          stateMutability: 'nonpayable',
        ...
        { inputs: [], name: 'startNextTerm', outputs: [], stateMutability: 'nonpayable', type: 'function' },
        {
          inputs: [],
          name: 'version',
          outputs: [{ internalType: 'string', name: '', type: 'string' }],
    ...
    },
    {
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/Hats-Protocol/jokerace-eligibility' }],
      parameters: [
        { label: 'Module Admin Hat ID', functionName: 'ADMIN_HAT', displayType: 'hat' },
        { label: 'Contest Address', functionName: 'underlyingContest', displayType: 'jokerace' },
        { label: 'Term End', functionName: 'termEnd', displayType: 'timestamp' },
        { label: 'Number Of Elected Hat Wearers', functionName: 'topK', displayType: 'default' },
      ],
      type: { eligibility: true, toggle: false, hatter: false },
      tags: [{ description: 'Indicates that the module is now deprecated', label: 'Deprecated', value: 'deprecated' }],
      ...
      customRoles: [{ id: 'jokeraceAdmin', name: 'JokeRace Admin', criteria: 'ADMIN_HAT', hatAdminsFallback: true }],
      writeFunctions: [
        {
          roles: ['public'],
        ...
        },
        {
          ...
          args: [
            ...
            { name: 'Top K', description: 'Amount of election winners', type: 'uint256', displayType: 'default' },
          ],
        },
      ],
      abi: [
        ...
        { inputs: [], name: 'JokeraceEligibility_ContestNotCompleted', type: 'error' },
        { inputs: [], name: 'JokeraceEligibility_NoTies', type: 'error' },
        { inputs: [], name: 'JokeraceEligibility_NotAdmin', type: 'error' },
        { inputs: [], name: 'JokeraceEligibility_TermNotCompleted', type: 'error' },
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: 'uint8', name: 'version', type: 'uint8' }],
          name: 'Initialized',
        ...
        },
        {
          anonymous: false,
          inputs: [
            { indexed: false, internalType: 'address', name: 'NewContest', type: 'address' },
            { indexed: false, internalType: 'uint256', name: 'newTopK', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'newTermEnd', type: 'uint256' },
          ],
          name: 'NewTerm',
          type: 'event',
        },
        ...
        { inputs: [], name: 'pullElectionResults', outputs: [], stateMutability: 'nonpayable', type: 'function' },
        {
          inputs: [
            { internalType: 'address', name: 'newUnderlyingContest', type: 'address' },
    ...
    },
    {
      ...
      abi: [
        ...
        { inputs: [], name: 'JokeraceEligibility_ContestNotCompleted', type: 'error' },
        { inputs: [], name: 'JokeraceEligibility_MustHaveDownvotingDisabled', type: 'error' },
        { inputs: [], name: 'JokeraceEligibility_MustHaveSortingEnabled', type: 'error' },
        { inputs: [], name: 'JokeraceEligibility_NotAdmin', type: 'error' },
        { inputs: [], name: 'JokeraceEligibility_TermNotCompleted', type: 'error' },
        {
          anonymous: false,
    ...
    },
    {
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/Hats-Protocol/jokerace-eligibility' }],
      parameters: [{ label: 'Module Admin Hat ID', functionName: 'ADMIN_HAT', displayType: 'hat' }],
      type: { eligibility: true, toggle: false, hatter: false },
      tags: [],
      implementationAddress: '0x0Bb0a2B9bc5Da206fead8e87D7Cbc6fCBa455320',
      deployments: [
        { chainId: '1', block: '20658461' },
        { chainId: '11155111', block: '6583390' },
        { chainId: '10', block: '124813980' },
        { chainId: '137', block: '61314105' },
        { chainId: '42161', block: '249098102' },
        { chainId: '100', block: '35784447' },
        { chainId: '8453', block: '19218822' },
        { chainId: '42220', block: '27524522' },
      ],
      creationArgs: {
        useHatId: true,
        immutable: [
          {
            name: 'Admin Hat',
            description:
              'Optional admin hat, granted a permission to create a new term. If not provided (equals zero), then this permission is granted to the admins of the hat',
            type: 'uint256',
            example: '26959946667150639794667015087019630673637144422540572481103610249216',
            displayType: 'hat',
            optional: true,
        ...
        mutable: [
          ...
          },
          {
            ...
            description:
              'Period of time after the term end when previous elected members are still considered eligible until a new term begins (in seconds)',
            type: 'uint256',
            example: '86400',
            displayType: 'seconds',
          },
      ...
      abi: [
        ...
        },
        {
          ...
          inputs: [
            ...
            { indexed: false, internalType: 'uint256', name: 'newTopK', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'newTermEnd', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'newTransitionPeriod', type: 'uint256' },
          ],
          name: 'NextTermSet',
          type: 'event',
        },
        {
          anonymous: false,
          inputs: [
            { indexed: false, internalType: 'address', name: 'contest', type: 'address' },
            { indexed: false, internalType: 'uint256', name: 'topK', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'termEnd', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'transitionPeriod', type: 'uint256' },
          ],
          name: 'TermStarted',
          type: 'event',
        },
        ...
        },
        {
          inputs: [
            ...
            { internalType: 'uint256', name: 'newTermEnd', type: 'uint256' },
            { internalType: 'uint256', name: 'newTransitionPeriod', type: 'uint256' },
        ...
        { inputs: [], name: 'startNextTerm', outputs: [], stateMutability: 'nonpayable', type: 'function' },
        {
          inputs: [{ internalType: 'uint256', name: 'termIndex', type: 'uint256' }],
          name: 'terms',
          outputs: [
            { internalType: 'address', name: 'contest', type: 'address' },
            { internalType: 'uint96', name: 'topK', type: 'uint96' },
            { internalType: 'uint256', name: 'termEnd', type: 'uint256' },
            { internalType: 'uint256', name: 'transitionPeriod', type: 'uint256' },
          ],
          stateMutability: 'view',
          type: 'function',
        },
    ...
    {
      id: 'haberdasher-labs_multi-claims-hatter',
      version: 'v0.1.0',
      name: 'Multi Claims Hatter',
      details: ['A Hats Protocol hatter contract enabling explicitly eligible wearers to claim a hat.'],
      links: [{ label: 'GitHub', link: 'https://github.com/Hats-Protocol/multi-claims-hatter' }],
      parameters: [],
      ...
      creationArgs: {
        ...
        mutable: [
          ...
          },
          {
            ...
            description:
              "'1' to make a hat claimable by its wearers, '2' to make a hat also claimable on behalf of wearers",
            type: 'uint8[]',
            example: [1],
            displayType: 'default',
          },
    ...
    },
    {
      ...
      deployments: [
        { chainId: '1', block: '19970940' },
        { chainId: '10', block: '129187047' },
        { chainId: '137', block: '65376155' },
        { chainId: '42161', block: '283858084' },
        { chainId: '8453', block: '23592025' },
        { chainId: '84532', block: '23151386' },
        { chainId: '42220', block: '29260055' },
        { chainId: '11155111', block: '5996152' },
      ],
      creationArgs: {
        useHatId: true,
        immutable: [],
    ...
    {
      id: 'haberdasher-labs_passthrough-module',
      version: 'v0.1.0',
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/Hats-Protocol/passthrough-modules' }],
      parameters: [{ label: 'Eligibility/Toggle Hat', functionName: 'CRITERION_HAT', displayType: 'hat' }],
      type: { eligibility: true, toggle: true, hatter: false },
      tags: [],
      ...
      customRoles: [
        { id: 'eligibilityTogglePassthrough', name: 'Eligibility/Toggle Passthrough', criteria: 'CRITERION_HAT' },
      ],
      writeFunctions: [
        {
    ...
    },
    {
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/Hats-Protocol/unlock-eligibility' }],
      parameters: [
        { label: 'Referrer', functionName: 'REFERRER', displayType: 'default' },
        { label: 'Referrer Fee Percentage', functionName: 'referrerFeePercentage', displayType: 'default' },
        { label: 'Lock Contract', functionName: 'lock', displayType: 'default' },
        { label: 'Price', functionName: 'keyPurchasePrice', displayType: 'amountWithDecimals' },
        { label: 'Token', functionName: 'keyPurchaseToken', displayType: 'token' },
        { label: 'Renewal Period', functionName: 'expirationDuration', displayType: 'seconds' },
        { label: 'Max Purchasers', functionName: 'maxNumberOfKeys', displayType: 'default' },
      ],
      type: { eligibility: true, toggle: false, hatter: true },
      tags: [],
      implementationAddress: '0x4c7803041851f7a17Fc6b5Ff5c911FC748160637',
      deployments: [
        { chainId: '11155111', block: '6699345' },
        { chainId: '10', block: '125422530' },
        { chainId: '137', block: '61873232' },
        { chainId: '42161', block: '253931725' },
        { chainId: '100', block: '36021503' },
        { chainId: '8453', block: '19827469' },
        { chainId: '42220', block: '27754441' },
      ],
      creationArgs: {
        useHatId: true,
        immutable: [],
      ...
      abi: [
        {
          inputs: [
            ...
            { internalType: 'uint256', name: '__referrerFeePercentage', type: 'uint256' },
            { internalType: 'address', name: '__initializer', type: 'address' },
          ],
          stateMutability: 'nonpayable',
          type: 'constructor',
        },
        { inputs: [], name: 'HatMintFailed', type: 'error' },
        { inputs: [], name: 'ImplementationAlreadyInitialized', type: 'error' },
        { inputs: [], name: 'InvalidReferrerFee', type: 'error' },
        { inputs: [], name: 'NotInitializer', type: 'error' },
        { inputs: [], name: 'NotLock', type: 'error' },
        { inputs: [], name: 'NotReferrer', type: 'error' },
        { inputs: [], name: 'NotTransferable', type: 'error' },
        { inputs: [], name: 'UnsupportedNetwork', type: 'error' },
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: 'uint256', name: 'referrerFeePercentage', type: 'uint256' }],
        ...
        },
        {
          inputs: [],
          name: 'lock',
          outputs: [{ internalType: 'contract IPublicLock', name: '', type: 'address' }],
          stateMutability: 'view',
          type: 'function',
        },
        {
        ...
        {
          inputs: [{ internalType: 'uint256', name: '_referrerFeePercentage', type: 'uint256' }],
        ...
        {
          inputs: [{ internalType: 'contract IUnlock', name: '_unlock', type: 'address' }],
          name: 'setUnlock',
          outputs: [],
          stateMutability: 'nonpayable',
          type: 'function',
    ...
    {
      id: 'haberdasher-labs_season-toggle',
      version: 'v0.1.0',
      name: 'Season Toggle',
      details: [
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/Hats-Protocol/season-toggle' }],
      parameters: [
        { label: 'Season End', functionName: 'seasonEnd', displayType: 'timestamp' },
        { label: 'Season Duration (Current Season Length)', functionName: 'seasonDuration', displayType: 'seconds' },
      ],
      ...
      creationArgs: {
        ...
        mutable: [
          ...
          },
          {
            ...
            description:
              'The proportion of the season that must elapse before the branch can be extended for another season, The value is treated as the numerator `x` in the expression `x / 10,000`',
            type: 'uint256',
            example: '5000',
            displayType: 'default',
          },
      ...
      writeFunctions: [
        {
          ...
          args: [
            ...
            },
            {
              name: 'Extension Delay',
              description:
                'Optional new proportion of the season that must elapse before the branch can be extended for another season, The value is treated as the numerator `x` in the expression `x / 10,000`',
              type: 'uint256',
              displayType: 'default',
            },
          ],
      ...
      abi: [
        {
          inputs: [{ internalType: 'string', name: '__version', type: 'string' }],
          stateMutability: 'nonpayable',
          type: 'constructor',
        },
        { inputs: [], name: 'SeasonToggle_InvalidExtensionDelay', type: 'error' },
        { inputs: [], name: 'SeasonToggle_NotBranchAdmin', type: 'error' },
        { inputs: [], name: 'SeasonToggle_NotExtendable', type: 'error' },
        { inputs: [], name: 'SeasonToggle_SeasonDurationTooShort', type: 'error' },
        {
          anonymous: false,
          inputs: [
            { indexed: false, internalType: 'uint256', name: '_branchRoot', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: '_duration', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: '_extensionDelay', type: 'uint256' },
          ],
          name: 'Extended',
          type: 'event',
        },
        ...
        },
        {
          inputs: [
            ...
            { internalType: 'uint256', name: '_extensionDelay', type: 'uint256' },
          ],
          name: 'extend',
          outputs: [],
          stateMutability: 'nonpayable',
    ...
    {
      id: 'haberdasher-labs_staking-eligibility',
      version: 'v0.1.0',
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/Hats-Protocol/staking-eligibility' }],
      parameters: [
        { label: 'Staking Token', functionName: 'TOKEN', displayType: 'erc20' },
        { label: 'Minimum Stake', functionName: 'minStake', displayType: 'amountWithDecimals' },
        { label: 'Judge Hat (Can Slash Wearers)', functionName: 'judgeHat', displayType: 'hat' },
        { label: 'Recipient Hat (Can Withdraw Slashed Stakes)', functionName: 'recipientHat', displayType: 'hat' },
      ],
      type: { eligibility: true, toggle: false, hatter: false },
      tags: [],
      ...
      creationArgs: {
        ...
        mutable: [
          ...
          },
          {
            ...
            description:
              'The number of seconds that must elapse between beginning an unstake and completing it. This should be set long enough to give a wearer of the judge hat enough time to slash a misbehaving staker before they can unstake',
            type: 'uint256',
            example: '86400',
            displayType: 'seconds',
          },
      ...
      customRoles: [
        { id: 'stakingJudge', name: 'Staking Judge', criteria: 'judgeHat' },
        { id: 'stakingRecipient', name: 'Staking Recipient', criteria: 'recipientHat' },
      ],
      writeFunctions: [
        {
          roles: ['public'],
        ...
        },
        {
          ...
          label: 'Begin Unstake',
          description:
            'Begin the process of unstaking an amount tokens by initiating a cooldown period, after which the tokens can be unstaked if the skater is not slashed in the meantime.',
          args: [
            {
              name: 'Amount',
              description: 'The amount of tokens to unstake',
        ...
        },
        {
          ...
          args: [{ name: 'Hat', description: 'The new recipient hat', type: 'uint256', displayType: 'hat' }],
        },
        {
          roles: ['hatAdmins'],
          ...
          description:
            'Change the number of seconds that must elapse between beginning an unstake and completing it. This period should be long enough that a wearer of the Judge Hat has enough time to slash a misbehaving staker before they can unstake.',
          args: [
            {
              name: 'Cooldown Period',
        ...
        },
        {
          ...
          primary: true,
          args: [{ name: 'Staker', description: 'The staker to slash', type: 'address', displayType: 'default' }],
        },
        {
          roles: ['stakingJudge'],
          functionName: 'forgive',
          ...
          args: [{ name: 'Staker', description: 'The staker to forgive', type: 'address', displayType: 'default' }],
        },
        {
      ...
      abi: [
        ...
        { inputs: [], name: 'StakingEligibility_AlreadySlashed', type: 'error' },
        { inputs: [], name: 'StakingEligibility_CooldownNotEnded', type: 'error' },
        { inputs: [], name: 'StakingEligibility_HatImmutable', type: 'error' },
        { inputs: [], name: 'StakingEligibility_InsufficientStake', type: 'error' },
        ...
        { inputs: [], name: 'StakingEligibility_NotRecipient', type: 'error' },
        { inputs: [], name: 'StakingEligibility_NotSlashed', type: 'error' },
        { inputs: [], name: 'StakingEligibility_NothingToWithdraw', type: 'error' },
        { inputs: [], name: 'StakingEligibility_TransferFailed', type: 'error' },
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: 'uint8', name: 'version', type: 'uint8' }],
          name: 'Initialized',
        ...
        },
        {
          ...
          inputs: [
            ...
            { indexed: false, internalType: 'uint248', name: 'minStake', type: 'uint248' },
            { indexed: false, internalType: 'uint256', name: 'judgeHat', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'recipientHat', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'cooldownPeriod', type: 'uint256' },
          ],
        ...
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: 'uint256', name: 'newJudgeHat', type: 'uint256' }],
          name: 'StakingEligibility_JudgeHatChanged',
          type: 'event',
        },
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: 'uint248', name: 'newMinStake', type: 'uint248' }],
          name: 'StakingEligibility_MinStakeChanged',
          type: 'event',
        },
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: 'uint256', name: 'newRecipientHat', type: 'uint256' }],
        ...
        },
        {
          ...
          inputs: [
            { indexed: false, internalType: 'address', name: 'wearer', type: 'address' },
            { indexed: false, internalType: 'uint248', name: 'amount', type: 'uint248' },
          ],
        ...
        {
          inputs: [{ internalType: 'uint248', name: '_amount', type: 'uint248' }],
          name: 'beginUnstake',
          outputs: [],
          stateMutability: 'nonpayable',
          type: 'function',
        ...
        {
          inputs: [{ internalType: 'uint256', name: '_cooldownPeriod', type: 'uint256' }],
        ...
        {
          inputs: [{ internalType: 'uint256', name: '_judgeHat', type: 'uint256' }],
          name: 'changeJudgeHat',
          outputs: [],
          stateMutability: 'nonpayable',
          type: 'function',
        ...
        {
          inputs: [{ internalType: 'uint248', name: '_minStake', type: 'uint248' }],
          name: 'changeMinStake',
          outputs: [],
          stateMutability: 'nonpayable',
          type: 'function',
        ...
        {
          inputs: [{ internalType: 'uint256', name: '_recipientHat', type: 'uint256' }],
    ...
    {
      id: 'haberdasher-labs_toggle-chain',
      version: 'v0.1.0',
      name: 'Toggles Chain',
      details: [
      ...
      creationArgs: {
        ...
        immutable: [
          ...
          },
          {
            ...
            description: 'The list of module instances to chain together',
            type: 'address[]',
            example: ['0xe1f50cd1078b4f7920c7d6657dc3d8d2e5155ae0', '0x4f28253ece7b52dd800160e7fecdb1c531a3fe1f'],
            displayType: 'default',
          },
        ],
        mutable: [],
    ...
    },
    {
      ...
      deployments: [
        { chainId: '1', block: '19574207' },
        { chainId: '11155111', block: '5619421' },
        { chainId: '10', block: '118267698' },
        { chainId: '42161', block: '197106268' },
        { chainId: '8453', block: '12672610' },
        { chainId: '84532', block: '23151707' },
        { chainId: '100', block: '33253854' },
        { chainId: '42220', block: '24892768' },
        { chainId: '137', block: '55392404' },
      ],
      creationArgs: {
        useHatId: true,
        immutable: [
    ...
    {
      id: 'pumpedlunch_erc1155-eligibility',
      version: 'v0.1.0',
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/pumpedlunch/HatsEligibilityModules' }],
      parameters: [
        { label: 'Token Address', functionName: 'TOKEN_ADDRESS', displayType: 'erc1155' },
        { label: 'Token IDs', functionName: 'TOKEN_IDS', displayType: 'default' },
        { label: 'Minimum Balances', functionName: 'MIN_BALANCES', displayType: 'default' },
      ],
      type: { eligibility: true, toggle: false, hatter: false },
      tags: [],
    ...
    {
      id: 'pumpedlunch_erc20-eligibility',
      version: 'v0.1.0',
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/pumpedlunch/HatsEligibilityModules' }],
      parameters: [
        { label: 'Token Address', functionName: 'ERC20_TOKEN_ADDRESS', displayType: 'erc20' },
        { label: 'Minimum Balance', functionName: 'MIN_BALANCE', displayType: 'amountWithDecimals' },
      ],
      type: { eligibility: true, toggle: false, hatter: false },
      tags: [],
    ...
    {
      id: 'pumpedlunch_erc721-eligibility',
      version: 'v0.1.0',
      ...
      links: [{ label: 'GitHub', link: 'https://github.com/pumpedlunch/HatsEligibilityModules' }],
      parameters: [
        { label: 'Token Address', functionName: 'ERC721_TOKEN_ADDRESS', displayType: 'erc721' },
        { label: 'Minimum Balance', functionName: 'MIN_BALANCE', displayType: 'default' },
      ],
      type: { eligibility: true, toggle: false, hatter: false },
      tags: [],
    ...
    {
      id: 'raid-guild_character-sheets-level-eligibility',
      version: 'v0.1.0',
      ...
      links: [
        { label: 'GitHub', link: 'https://github.com/raid-guild/character-sheets-contracts' },
      ...
      parameters: [
        { label: 'CharacterSheet', functionName: 'SHEETS_ADDRESS', displayType: 'address' },
        { label: 'Classes Token', functionName: 'CLASSES_ADDRESS', displayType: 'default' },
      ],
      type: { eligibility: true, toggle: false, hatter: false },
      tags: [],
      ...
      writeFunctions: [
        {
          ...
          primary: true,
          args: [
            { name: 'Class IDs', description: 'Classes to add', type: 'uint256[]', displayType: 'default' },
            {
              name: 'Min Levels',
      ...
      abi: [
        ...
        { inputs: [], name: 'ElderEligibility_HatImmutable', type: 'error' },
        { inputs: [], name: 'ElderEligibility_NotHatAdmin', type: 'error' },
        ...
        {
          inputs: [
            { internalType: 'uint256[]', name: '_classIds', type: 'uint256[]' },
            { internalType: 'uint256[]', name: '_minLevels', type: 'uint256[]' },
          ],
          name: 'addClasses',
          outputs: [],
          stateMutability: 'nonpayable',
