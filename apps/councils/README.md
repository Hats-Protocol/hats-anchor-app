...
To start the development server run `pnpm councils:dev` from the root of the project (not this directory). The server will be running on http://localhost:3000/.

## Build production application

To test your local instance for a production build run `pnpm councils:build` from the root of the project (not this directory).
