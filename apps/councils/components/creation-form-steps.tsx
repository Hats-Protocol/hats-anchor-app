              ...
              <div className='my-3 ml-[23px]'>
                {step.subSteps.map((subStep, subIndex) => {
                  ...
                  return (
                    <div
                      key={subStep.id}
                      className={`flex items-center gap-3 border-l-[2px] ${isCompleted ? 'border-l-blue-500' : 'border-l-gray-200'}`}
                    >
                      <div
                        className={`my-1 ml-4 flex h-6 w-6 items-center justify-center rounded-full ${isCurrent ? 'border border-blue-500 bg-blue-100' : 'border border-gray-200 bg-white'}`}
                      >
                        {isCompleted ? (
                          <svg
                            width='44'
