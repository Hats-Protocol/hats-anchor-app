    ...
    <form className='flex h-full flex-col space-y-6' onSubmit={form.handleSubmit(onNext)}>
      <div className='flex-1 space-y-6'>
        ...
        <div className='space-y-2'>
          ...
          <Input name='councilName' localForm={form} placeholder='Council Name' options={{ required: true }} />
        </div>
        ...
        <div className='space-y-2'>
          ...
          <ChainSelect name='chain' form={form} options={CHAIN_OPTIONS} placeholder='Select a chain' />
        </div>
        ...
        <div className='space-y-2'>
          ...
          <Textarea name='councilDescription' localForm={form} placeholder='Bylaws, policies or important links' />
        </div>
      </div>
