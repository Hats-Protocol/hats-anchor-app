...
export const EligibilityContext = createContext<EligibilityContext>({
  chainId: undefined,
  treeId: undefined,
  topHat: undefined,
  // tree
...
export const EligibilityContextProvider = ({
  ...
  return (
    <EligibilityContext.Provider value={returnValue}>
      {children}
    </EligibilityContext.Provider>
  );
};

export const useTreeForm = () => useContext(EligibilityContext);
